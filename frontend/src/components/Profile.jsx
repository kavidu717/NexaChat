const Profile = ({authUser,onClose}) => {
   if(!authUser) return null;
     return(
      ...
      <div className="bg-gray-900 border border-gray-800 p-8 rounded-2xl w-full max-w-sm text-center shadow-2xl">
        ...
        <button 
          onClick={onClose}
          className="mt-8 w-full bg-orange-600 text-white py-3 rounded-xl font-bold hover:bg-orange-500 transition-all"
        >
          Close
        </button>
      </div>
